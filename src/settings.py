...
VERIFICATION_CUTOFF = timedelta(weeks=1).total_seconds()
...
This shouldn't be required in normal usage as the statistical tests will almost always ensure this is true regardless"""