import math
from typing import Callable, Generator, Iterable, MutableSequence, Optional
...
class Chronology[T](MutableSequence[T]):
    ...
    def __init__(self, iterable: Optional[Iterable[T]] = None, *, epoch_length: Optional[float] = None, key: Optional[Callable[[T], float]] = None):
        '''
        Args:
    ...
    def _latest_before(self, time: float) -> _ChronologyNode | None:
        ...
        Returns:
            _ChronologyNode: The latest node occuring before the cutoff (inclusive)'''
    ...
    def add(self, event: T) -> _Event[T] | None:
